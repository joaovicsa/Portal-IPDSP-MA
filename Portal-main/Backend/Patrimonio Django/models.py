...
class Produto(models.Model):
	...
	tombamento = 		models.CharField(max_length = 15, null = False)
	...
	valor = 			models.DecimalField(null = False, max_digits = 1000000, decimal_places = 2, help_text="Valor do Produto")
	desconto = 			models.DecimalField(null=True, help_text="Insira o valor em Real.", decimal_places=2,max_digits=1000000)
	...
	categoria = 		models.CharField(max_length=50, null=False, choices=CATEGORIA_DE_PRODUTOS.choices)
